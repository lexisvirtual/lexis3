...
async function testCompleteFlow() {
  ...
  for (const category of CATEGORIES) {
    ...
    try {
      const url = `https://pixabay.com/api/?key=${API_KEY}&q=${encodeURIComponent(QUERIES[category])}&image_type=photo&orientation=horizontal&per_page=3`; // Pixabay minimum is 3

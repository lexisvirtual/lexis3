...
> **Nota Estratégica:** Este documento é subordinado ao `PROJECT_VISION.md`. Ele detalha a infraestrutura técnica e de automação de imagens da linha lógica Lexis.

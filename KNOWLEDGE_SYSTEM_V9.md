...
Este documento resume o **Motor Técnico** do projeto Lexis. Ele detalha a execução das estratégias de automação e ativos, servindo como braço tecnológico do [PROJECT_VISION.md](./PROJECT_VISION.md).

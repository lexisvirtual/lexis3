...
> **Nota Estratégica:** Este documento é subordinado ao [PROJECT_VISION.md](./PROJECT_VISION.md). Ele descreve a infraestrutura técnica V9 para mitigação de riscos de dependência externa.

...
> **Nota Estratégica:** Este documento é subordinado à [PROJECT_VISION.md](PROJECT_VISION.md). Ele define a arquitetura de persistência de mídia e governança de imagem.

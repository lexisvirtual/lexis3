...
> **Nota Estratégica:** Este documento é subordinado ao [PROJECT_VISION.md](PROJECT_VISION.md). Ele detalha a infraestrutura técnica que mitiga o risco de dependência de APIs externas.

...
> **Nota Estratégica:** Este documento é subordinado ao [PROJECT_VISION.md](./PROJECT_VISION.md). Ele define a inteligência de Escala e Governança Técnica do projeto.

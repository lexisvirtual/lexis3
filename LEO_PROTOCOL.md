...
> **Nota Estratégica:** Este protocolo é uma extensão técnica do [PROJECT_VISION.md](PROJECT_VISION.md). Consulte a Visão do Projeto para entender a linha lógica completa (Pedagogia -> Marketing -> Técnico).

...
> **Nota Estratégica:** Este documento é subordinado à [PROJECT_VISION.md](PROJECT_VISION.md). Ele detalha a execução técnica e o cérebro algorítmico do Leo dentro da visão V9.1.

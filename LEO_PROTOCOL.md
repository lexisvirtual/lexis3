...
> **Nota Estratégica:** Este documento é subordinado ao [PROJECT_VISION.md](PROJECT_VISION.md). Ele define a execução técnica da "Escala" e "Governança" via SEO Programático e otimização de ROI.

...
Este documento é o cérebro algorítmico do Leo. Define gatilhos, decisões e ações corretivas baseadas em métricas REAIS. Para o alinhamento estratégico macro, consulte o [PROJECT_VISION.md](./PROJECT_VISION.md).

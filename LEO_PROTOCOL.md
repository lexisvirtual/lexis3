...
> **Nota Estratégica**: Este documento é subordinado à [PROJECT_VISION.md](PROJECT_VISION.md). Ele detalha a execução técnica de Escala e Aquisição via SEO Programático.

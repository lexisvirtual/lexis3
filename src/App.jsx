        ...
        <nav className={`fixed top-0 w-full z-[100] transition-all duration-500 ${scrolled ? "navbar-blur py-3 shadow-2xl" : "bg-transparent py-8"}`}>
            <div className="max-w-7xl mx-auto px-8 flex justify-between items-center">
                <div className="flex items-center gap-3 group cursor-pointer" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
                    <img src="logo.png" alt="Logo Lexis Academy - Escola de Inglês por Imersão" className="w-10 h-10 object-contain group-hover:rotate-12 transition-transform duration-300" loading="eager" />
                ...
                <div className="hidden md:flex items-center gap-8 text-[11px] font-extrabold uppercase tracking-[0.15em] text-[#94a3b8]">
                    <a href="#inicio" className="hover:text-[#fbd24c] transition-colors relative group">Início</a>
                    <a href="#modalidades" className="hover:text-[#fbd24c] transition-colors relative group">Modalidades</a>
                    <a href="#conteudo" className="hover:text-[#fbd24c] transition-colors relative group">Conteúdo</a>
                    <a href="#metodo" className="hover:text-[#fbd24c] transition-colors relative group">Método</a>
                    <a href="#depoimentos" className="hover:text-[#fbd24c] transition-colors relative group">Depoimentos</a>
                </div>
...
const App = () => {
    ...
    return (
        <div className="flex flex-col w-full min-h-screen">
            ...
            {/* MODALIDADES - ARQUITETURAS DE SUCESSO (REFINED) */}
                    ...
                    <div className="grid lg:grid-cols-3 gap-8 items-stretch">
                            ...
                            <div className="p-8 md:p-10 flex flex-col h-full">
                                ...
                                <ul className="space-y-4 mb-10 text-sm font-medium">
                                    <li className="flex items-start gap-3">
                                        ...
                                        <span className="text-slate-300"><strong>Aulas ao vivo:</strong> 3h diárias (19h-22h) para interação real.</span>
                                    </li>
                                    <li className="flex items-start gap-3">
                                        <span className="w-1.5 h-1.5 rounded-full bg-amber-400 mt-2 shrink-0"></span>
                                        <span className="text-slate-300"><strong>Repetição Espaçada:</strong> Retenção acelerada de longo prazo.</span>
                                    </li>
                                    <li className="flex items-start gap-3">
                                        <span className="w-1.5 h-1.5 rounded-full bg-amber-400 mt-2 shrink-0"></span>
                                        <span className="text-slate-300"><strong>Garantia Vitalícia:</strong> Refaça o curso sem custo adicional.</span>
                                    </li>
                                </ul>
                        ...
                        <div className="modality-card bg-slate-900 border-lexisPurple/50 ring-1 ring-lexisPurple/30 flex flex-col h-full group reveal reveal-delay-1 lg:scale-105 z-20 shadow-2xl shadow-lexisPurple/20">
                            <div className="p-8 md:p-10 flex flex-col h-full relative">
                                ...
                                <ul className="space-y-4 mb-10 text-sm font-medium">
                                    <li className="flex items-start gap-3">
                                        <span className="w-1.5 h-1.5 rounded-full bg-lexisPurple mt-2 shrink-0"></span>
                                        <span className="text-slate-200"><strong>Business Focus:</strong> Simulações reais de reuniões e viagens.</span>
                                    </li>
                                    <li className="flex items-start gap-3">
                                        <span className="w-1.5 h-1.5 rounded-full bg-lexisPurple mt-2 shrink-0"></span>
                                        <span className="text-slate-200"><strong>Ambientação Segura:</strong> Destrava a fala sem medo de errar.</span>
                                    </li>
                                    <li className="flex items-start gap-3">
                                        <span className="w-1.5 h-1.5 rounded-full bg-lexisPurple mt-2 shrink-0"></span>
                                        <span className="text-slate-200"><strong>Hospedagem:</strong> Indicação de acomodação estratégica inclusa.</span>
                                    </li>
                                </ul>
                            ...
                            <div className="p-8 md:p-10 flex flex-col h-full">
                                ...
                                <ul className="space-y-4 mb-10 text-sm font-medium">
                                    <li className="flex items-start gap-3">
                                        ...
                                        <span className="text-slate-300"><strong>Multiturnos:</strong> 5 horários diferentes (7h-21h) com aulas idênticas.</span>
                                    </li>
                                    <li className="flex items-start gap-3">
                                        <span className="w-1.5 h-1.5 rounded-full bg-blue-500 mt-2 shrink-0"></span>
                                        <span className="text-slate-300"><strong>Entrada Contínua:</strong> Comece em qualquer dia das 48 semanas do ano.</span>
                                    </li>
                                    <li className="flex items-start gap-3">
                                        <span className="w-1.5 h-1.5 rounded-full bg-blue-500 mt-2 shrink-0"></span>
                                        <span className="text-slate-300"><strong>Experiência Híbrida:</strong> Opção de complementar com plataforma digital.</span>
                                    </li>
                                </ul>
